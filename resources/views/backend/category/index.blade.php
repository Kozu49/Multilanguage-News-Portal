                      ...
                      <table class="table table-bordered">
                        ...
                        @foreach($categories as $category)
                          ...
                          <td> {{$i++}} </td>
                            ...
                            <td> {{$category->category_nep}} </td>    
                            <td>  
                                <a href="{{route('edit.category',$category->id)}}" class="btn btn-info">Edit</a>
                                <a href="{{route('delete.category',$category->id)}}" onclick="return confirm('Are you sure?')" class="btn btn-danger">Delete</a>
                            </td>                           
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
                      {{$categories->links('pagination-link')}}
                    </div>
                  </div>
                </div>
              </div>
