      ...
      <div class="card-body">
          ...
          @csrf
              ...
              <div class="form-group" >
                ...
                <input type="text" class="form-control" value="{{$video->title}}" name="title" id="exampleInputName1" >
              </div>

              <div class="form-group" >
                <label for="exampleInputName1">Embed Code</label>
                <input type="text" class="form-control" value="{{$video->embed_code}}" name="embed_code" id="exampleInputName1" >
              </div>
            ...
            <div class="form-group ">
              <label for="exampleSelectGender">Video Type</label>
                <select class="form-control" name="type" value="{{$video->type}}" id="exampleSelectGender">
                  <option value="1"
                  <?php if($video->type==1) echo "selected" ; ?>

                  >Big Video</option>
                  <option value="0"
                  <?php if($video->type==0) echo "selected" ; ?>
                  >Small Video</option>
