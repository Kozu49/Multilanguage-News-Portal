            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{route('update.subdistrict',$subdistrict->id)}}" class="forms-sample">
                    @csrf  
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subdistrict_nep" value="{{$subdistrict->subdistrict_nep}}">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="district_id" id="exampleFormControlSelect2">
                        <option class disabled="" selected="">--Select District</option>
