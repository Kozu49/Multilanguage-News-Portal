            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{route('update.seo',$seo->id)}}" class="forms-sample">
                    @csrf  
                    ...
                    <textarea class="form-control" name="meta_description"  class="form-control" id="summernote2">{{$seo->meta_description}}</textarea>
                    ...
                    <textarea class="form-control" name="google_analytics" class="form-control" id="summernote3">{{$seo->google_analytics}}</textarea>
                    ...
                    <textarea class="form-control" name="alexa_analytics" class="form-control" id="summernote4">{{$seo->alexa_analytics}}</textarea>
