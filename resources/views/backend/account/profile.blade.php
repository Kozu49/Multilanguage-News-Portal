    ...
    <div class="card">
      <div class="card-body">
            ...
            <div class="template-demo">
                    <a href="{{route('edit.profile',$edit->id)}}"><button type="button" class="btn btn-primary btn-fw" style="float:right;">Edit Profile</button></a>
                    </div>

            <div class="card" style="width: 18rem;">
  <img src="{{asset('image/profileimage/'.$edit->image)}}" class="card-img-top" alt="...">
  <div class="card-body">
