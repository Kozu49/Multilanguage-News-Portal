            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{route('update.district',$district->id)}}" class="forms-sample">
                    @csrf  
                    <div class="form-group">
                        <label for="exampleInputUsername1">District English</label>
                        <input type="text" class="form-control" name="district_eng" value="{{$district->district_eng}}">
                        @error('district_eng')
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="district_nep" value="{{$district->district_nep}}">
                        @error('district_nep')
                            <span class="text-danger">{{$message}}</span>
                        @enderror  
                    </div>
