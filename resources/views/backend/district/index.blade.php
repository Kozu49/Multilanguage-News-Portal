                      ...
                      <table class="table table-bordered">
                        ...
                        @foreach($districts as $district)
                          ...
                          <td> {{$i++}} </td>
                            ...
                            <td> {{$district->district_nep}} </td>    
                            <td>  
                                <a href="{{route('edit.district',$district->id)}}" class="btn btn-info">Edit</a>
                                <a href="{{route('delete.district',$district->id)}}" onclick="return confirm('Are you sure?')" class="btn btn-danger">Delete</a>
                            </td>                           
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
                      {{$districts->links('pagination-link')}}
                    </div>
                  </div>
                </div>
              </div>
