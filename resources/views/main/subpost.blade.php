...
<section class="single_page">						
		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-8">				
				...
				@foreach($subcatposts as $subcatpost)
				<div class="archive_post_sec_again">
					<div class="row">
						<div class="col-md-4 col-sm-5">
							<div class="archive_img_again">
								<a href="#"><img src="{{asset('image/postimg/'.$subcatpost->image)}}" alt="Notebook"></a>
							</div>
						</div>
						<div class="col-md-8 col-sm-7">
							<div class="archive_padding_again">
								<div class="archive_heading_01">
									...
									{{$subcatpost->title_eng}}
									@else
									{{$subcatpost->title_nep}}
									@endif
									</a>
								</div>
								<div class="archive_dtails">
								@if(session()->get('lang')=='english')
									{!! Str::limit($subcatpost->details_eng,200) !!}
									
									@else

									{!! Str::limit($subcatpost->details_nep,200) !!}
								@endif

									
									
								</div>
								<div class="dtails_btn"><a href="{{route('view.post',$subcatpost->id)}}">
								@if(session()->get('lang')=='english')
									Read More..
									@else
									थप पढ्नुहोस्..
				...
				{{$subcatposts->links('pagination-link')}}
